...
def fast_data_files_to_dataframe(file_list):
...
if __name__ == '__main__':
    ...
    print(args.input_file_list)
    
    fast_df = fast_data_files_to_dataframe(args.input_file_list)
    ...
    for prefix1, prefix2 in variable_prefixes_for_spectra_calculation:
        for suffix in suffixes:
            spectra_result = calculate_mrd_for_df(fast_df, prefix1 + suffix, prefix2 + suffix, shift = args.shift, parallelism=args.parallelism)
