...
class SOSTidy:
    ...
    def get_tidy_dataset(ds, variable_names):
        ...
        tidy_df['height'] = tidy_df['variable'].apply(SOSTidy._height_from_variable_name)
        tidy_df['tower'] = tidy_df['variable'].apply(SOSTidy._tower_from_variable_name)
        tidy_df['measurement'] = tidy_df['variable'].apply(SOSTidy._measurement_from_variable_name)
        return tidy_df
